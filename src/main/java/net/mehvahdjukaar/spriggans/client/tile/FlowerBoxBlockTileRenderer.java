...
import net.mehvahdjukaar.spriggans.blocks.FlowerBoxBlock;
import net.mehvahdjukaar.spriggans.blocks.FlowerBoxBlockTile;
...
public class FlowerBoxBlockTileRenderer extends TileEntityRenderer<FlowerBoxBlockTile> {
    ...
    protected static final List<Quaternion> rots = Arrays.asList(Y90,Y180,YN90);
