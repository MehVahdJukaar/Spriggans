package net.mehvahdjukaar.spriggans.client.particle;
...
@OnlyIn(Dist.CLIENT)
public class SprigganLeafParticle extends SpriteTexturedParticle {
    private final float rotSpeed;

    private SprigganLeafParticle(ClientWorld worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double particleRedIn, double particleGreenIn, double particleBlueIn) {
    ...
    public static class Factory implements IParticleFactory<BasicParticleType> {
        ...
        public Particle createParticle(BasicParticleType typeIn, ClientWorld worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            SprigganLeafParticle particle = new SprigganLeafParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed);
